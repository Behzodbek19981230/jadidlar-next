...
export default function NewsDetail() {
  ...
  return (
    <div className="container_full ">
      <Menu title="Yangiliklar" link="/newsDetail" subtitle={apiData?.title} />
      ...
      <div className="global_share">
        ...
        <a
          onClick={() =>
            (window.location.href = `https://telegram.me/share/url?url=http://jadidlar.uz/newsDetail/${apiData?.id}`)
          }
          target="_blank"
        >
          <FaTelegramPlane />
