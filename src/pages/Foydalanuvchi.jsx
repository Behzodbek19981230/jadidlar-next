  ...
  return (
    <div className="foydalanuvchi_container">
      ...
      <div className="foydalanuvchi_content">
        ...
        <h6>
          <Link href="/jadidlarAll">Jadidlar</Link> sandig'i
        </h6>
        ...
        <h6>
          <Link href="">Til va Imlo</Link> sandig'i
        </h6>
        ...
        <h6>
          <Link href="">Manbalar</Link> sandig'i
        </h6>
        ...
        <h6>
          <Link href="">Izlanishlar</Link> sandig'i
        </h6>
        ...
        <h6>
          <Link href="">Turkiston Muxtoriyati</Link> sandig'i
        </h6>
        ...
        <h6>
          <Link href="">Voqealar </Link> sandig'i
        </h6>
        ...
        <h6>
          <Link href="">Foydalanuvchiga </Link> sandig'i
        </h6>
        ...
        <h6>
          <Link href="">Biz Haqimizda </Link> sandig'i
        </h6>
        <div className="foydalanuvchi_bolak bolak_14">
          <h3 className="bolak_title">
            {" "}
